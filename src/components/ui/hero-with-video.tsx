  ...
  const ThemeToggleButton = () => {
    ...
    return (
      <button
        ...
        className="bg-muted hover:bg-border flex-shrink-0 p-2.5 rounded-full transition-colors cursor-pointer"
      ...
      <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="py-2 relative z-20 flex items-center justify-between gap-4">
            ...
            <nav className="hidden lg:flex text-muted-foreground font-medium">
              <ul className="flex items-center space-x-2">
                ...
                <li className="relative">
                  <button onClick={() => toggleDropdown("desktop-resources")} className="flex items-center hover:text-foreground px-3 py-2 text-sm transition-colors rounded-lg cursor-pointer">
                ...
                <li className="relative">
                  <button onClick={() => toggleDropdown("desktop-pricing")} className="flex items-center hover:text-foreground px-3 py-2 text-sm transition-colors rounded-lg cursor-pointer">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden lg:flex items-center gap-3">
              ...
              <button className="bg-foreground hover:bg-muted-foreground text-background py-2.5 px-5 text-sm rounded-xl capitalize font-medium transition-colors flex items-center gap-2 cursor-pointer">
                Get Started<ArrowRight className="h-4 w-4" />
              </button>
            </div>
            <ThemeToggleButton />
            <div className="lg:hidden relative">
              <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="bg-transparent hover:bg-muted border-none p-2 rounded-xl transition-colors cursor-pointer">
              ...
              {isMobileMenuOpen && (
                <ul className="absolute top-full right-0 mt-2 p-2 shadow-lg bg-card border border-border rounded-xl w-56 z-30">
                  ...
                  <li><button onClick={() => toggleDropdown("mobile-resources")} className="w-full flex items-center justify-between px-3 py-2 text-sm text-foreground hover:bg-muted rounded-lg cursor-pointer">
                  ...
                  <li><button onClick={() => toggleDropdown("mobile-pricing")} className="w-full flex items-center justify-between px-3 py-2 text-sm text-foreground hover:bg-muted rounded-lg cursor-pointer">
                  ...
                  <li className="border-t border-border mt-2 pt-2 space-y-2">
                    ...
                    <button className="w-full bg-foreground text-background hover:bg-muted-foreground px-3 py-2.5 text-sm rounded-lg flex items-center justify-center gap-2 font-medium cursor-pointer">
                      Get Started<ArrowRight className="h-4 w-4" />
                    </button>
                  </li>
                </ul>
        ...
        <div className="pt-4 pb-10 sm:pt-6 sm:pb-12 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-8 flex items-center justify-center gap-3 sm:gap-4 flex-wrap">
              ...
              <button onClick={handleEmailSubmit} className="bg-foreground hover:bg-muted-foreground text-background px-5 py-2 text-sm sm:px-6 sm:py-3 sm:text-base rounded-full normal-case font-medium transition-colors flex items-center gap-2 cursor-pointer">
        ...
        <header className="relative w-full aspect-video rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-5 right-5 z-10">
            {!isVideoPlaying ? (
              <button onClick={handlePlayVideo} className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center hover:bg-white/30 transition-all duration-200 shadow-lg cursor-pointer">
                <Play className="h-7 w-7 text-white fill-white ml-1" />
              </button>
            ) : (
              <button onClick={isVideoPaused ? handleResumeVideo : handlePauseVideo} className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center hover:bg-white/30 transition-all duration-200 shadow-lg cursor-pointer">
