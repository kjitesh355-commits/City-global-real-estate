  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 flex items-end justify-center animate-in fade-in zoom-in-95 duration-500"
          style={{
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gray-900 text-sm text-gray-400">
            No image
          </div>
        )}
      </div>
